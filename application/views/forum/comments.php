...
<?php
$sorted_order_ids = $this->forum_model->get_post_comments($post->comment_id);
?>
...
else
{
   ...
   {         
      ...
      $picture = $this->forum_model->get_profile_picture($comment->user_id);
                  ...
                  <div class="card z-depth-2">
                     <div class="card-content">
                        ...
                        <p align="right" class="grey-text">
                           <small><?php echo $this->forum_model->get_time($comment->initial_time); ?></small>
                        </p>
                     </div>
