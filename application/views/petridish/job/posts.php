...
else
{
   ...
   ----------------------------------------------------->
               <div class="card-content hide-on-med-and-down" style="margin: 0px 5px;">
                  ...
                  <!-- DATE & TIME -->
                  <h6 class="grey-text text-darken-2">&nbsp;&nbsp;<?php echo $this->petridish_model->user_name($post->user_id); ?> posted on           
                     <?php echo $post->month." ".$post->day.", ".$post->yr; ?>&nbsp;at&nbsp;<?php echo $this->petridish_model->get_time($post->initial_time); ?>.
                  </h6>
                           ...
                           <a class="active" onclick="return toggle('comments.<?php echo $post->comment_id; ?>');">
                              <h5>                              
                                 <span class="grey-text text-darken-2">
                                    <small><?php echo $this->petridish_model->get_num_comments($post->comment_id); ?>:&nbsp;Comments</small>
                                 </span>
                              </h5>
                           </a>
                        </div>
                        ...
                        <div class="col s6 m6 l6">
                           <h6 class="grey-text text-darken-2">
                              ...
                              <a onclick="return toggle('comments.<?php echo $post->comment_id; ?>');">
                                 <span class="grey-text text-darken-2">
                                    <?php echo $this->petridish_model->get_num_comments($post->comment_id); ?>
                                    :&nbsp;Comments
                                 </span>
                              </a>
                           </h6>
