   ...
   <ul class="collapsible popout" data-collapsible="accordion">
      <li>
         ...
         <div class="collapsible-header hoverable z-depth-0">
            <i class="material-icons green-text">mode_edit</i>Post and share your job opportunity.
         </div>
...
<?php } else { ?>
   <div class="card">
      <div align="center" class="card-content">
         ...
         <span class="blue-text">Login</span> to <span class="green-text">post</span> a job opportunity.
      </div>
   </div>
<?php } ?>