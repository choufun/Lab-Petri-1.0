         ...
         <div class="content">
            <h4 align="center" class="index-content">
               <ul id="slide-out" class="side-nav">
                  <li>
                     <a class="modal-trigger blue white-text waves-effect" href="#modal1">
                        Profile Picture
                     </a>
                  </li>
                  
<!-- Modal Structure => UPLOAD PROFILE PICTURE
----------------------------------------------------------------------------------->
                     ...
                     <div class="modal-content">
                        <div class="card">
                           <div align="center" class="blue white-text">
                              <div class="profile">
                                 <a href="#!" class="right modal-action modal-close waves-effect btn-flat white-text">
                                    x
                                 </a>
                                 <center>
                                    <img class="image" src="assets/profile_pic/profile.jpg" alt="Profile Picture">
