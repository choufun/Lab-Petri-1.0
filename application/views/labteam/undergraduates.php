...
{ 
    ...
    { ?>
      ...
      src="users/<?php echo $object->user_id; ?>/pictures/<?php echo $this->labteam_model->get_profile_picture($object->user_id); ?>"
      id="profile-image">&nbsp;
                           </div>
                           <div class="col s8 m8 l8">
                              <div align="center">                                 
                                 <h5><?php echo $this->labteam_model->get_user($object->user_id); ?></h5>
                              </div>
                           </div>
                        </div>
                     </div>
                     <div class="row">
                        ...
                        <div class="col s4 m4 l4">
                  <?php if ($this->labteam_model->get_status($object->user_id) === "pending")
                        { ?>
                           <h6 class="grey-text">Pending</h6>
                  <?php }
                        elseif ($this->labteam_model->get_status($object->user_id) === "accepted")
                        { ?>
                           <a href="message?id=<?php echo $object->user_id;?>">Message</a>
                  <?php }
                        else
                        { ?>                        
                           <a class="green-text" href="labteam/connect?id=<?php echo $object->user_id;?>">
                              Connect
                           </a>
                  <?php } ?>
                        </div>
