...
<div class="card-content">
    <br>
    <h4 class="blue-text text-darken-3" style="font-family:Palatino Linotype; margin-right: 150px" align="right"><b><i>"The whole is greater than the sum of it’s parts."</i></b></h4>
    <br><br>
    <div class="row">
            ...
            <div class="row">
                <div class="hoverable col s12 m12 l4">
                    <div class="card z-depth-0 hoverable" style="padding: 1px 1px;">
                        <div class="card-content">
                            <div align="center">
                                <img class="responsive-img z-depth-3 circle" style="height: 150px; width: 150px;"
                ...
                <div class="hoverable col s12 m12 l4">
                    <div class="card z-depth-0 hoverable" style="padding: 1px 1px;">
                        <div class="card-content">
                            <div align="center">
                                <img class="responsive-img z-depth-3 circle" style="height: 150px; width: 150px;"
                                     src="../../assets/img/phillip.jpg"
                                     id="profile-image">
                            </div>
                            <h4 class="blue-text text-darken-4" align="center">
                                <strong>Phillip Kwong</strong>
                                <br>
                    ...
                    <div class="card z-depth-0 hoverable" style="padding: 1px 1px;">
                        <div class="card-content">
                            ...
                            <h4 class="blue-text text-darken-4" align="center">
                                ...
                                <br>
                                <small class="black-text"><small>Mobile Developer</small></small>
                            </h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="hoverable col s12 m12 l4">
                    <div class="card z-depth-0 hoverable" style="padding: 1px 1px;">
                        <div class="card-content">
                            <div align="center">
                                <img class="responsive-img z-depth-3 circle" style="height: 150px; width: 150px;"
                                     src="../../assets/img/winnie_lam.jpg"
                                     id="profile-image">
                            </div>
                            <h4 class="blue-text text-darken-4" align="center">
                                <strong>Winnie Lam</strong>
                                <br>
                                <small class="black-text"><small>Software Engineer</small></small>
                            </h4>
                        </div>
