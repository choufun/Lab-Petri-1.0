      ...
      <ul class="collapsible popout" data-collapsible="accordion" id="post_blog">
         <li>
            <div class="collapsible-header hoverable z-depth-0">
               <h5 class="grey-text text-darken-2 hide-on-med-and-down"><small><i class="material-icons blue-grey-text">mode_edit</i>Post Your Blog.</small></h5>
               <h6 class="grey-text text-darken-2 hide-on-large-only"><small><i class="material-icons blue-grey-text">mode_edit</i>Post Your Blog.</small></h6>
            </div>            
