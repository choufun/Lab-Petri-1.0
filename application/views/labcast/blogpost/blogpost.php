   ...
   <div class="row">
      <div class="col s12 m10 offset-m1">  
         <div class="card z-depth-1">
            <?php include 'application/views/petridish/post/top.php';?>         
            <?php include 'application/views/petridish/post/middle.php';?>
            <div class="divider"></div>
            <?php include 'application/views/petridish/post/bottom.php';?>
            <div class="divider"></div>
            <?php include 'application/views/petridish/post/comments.php';?>
         </div>
      </div>
   </div>
</div>
